...
export default function Hero() {
  ...
  const fullText = "Full Stack Web Developer | MERN | Cloud ";
  ...
  return (
    ...
    >
      ...
      <div 
        ...
        style={{ 
          backgroundImage: "url('https://www.shutterstock.com/image-vector/black-red-purple-silk-satin-260nw-2709704487.jpg')",
      ...
      >
        ...
        >
          <a href="#projects" className="group relative px-8 py-3 bg-primary text-white font-bold rounded-full overflow-hidden flex items-center gap-2 hover:scale-105 transition-transform">
          ...
          <a href="#contact" className="px-8 py-3 glass hover:bg-white/10 text-white font-bold rounded-full transition-colors border border-white/10 hover:border-primary/50">
            Contact Me
          </a>
        </motion.div>
      </motion.div>
